...
<p align="center">
  ...
  <img alt="tests" src="https://img.shields.io/badge/pytest-8%20passed-1E2329?logo=pytest&logoColor=2EBD85">
...
**Тесты и валидация:**
```bash
pip install -r requirements-dev.txt && pytest -q     # 8 тестов, ≈10 с
