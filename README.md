...
<p align="center">
  <img alt="Python" src="https://img.shields.io/badge/Python-3.10+-1E2329?logo=python&logoColor=F0B429">
  ...
  <img alt="tests" src="https://img.shields.io/badge/pytest-7%20passed-1E2329?logo=pytest&logoColor=2EBD85">
...
| **35 → 185** | компонент связности, если заблокировать топ-10: сеть распадается |
...
**5. Сборщики второго уровня.** Второй проход правил находит узлы, которым платят другие сборщики и распределители.
...
| `fast_share` | доля поступлений, после которых ≥50% суммы ушло дальше за ≤2 дня |
...
| 16 компонент связности | Louvain по всем компонентам; оценка устойчивости сети по компонентам |
...
| Экран | Что даёт |
|---|---|
| **Приоритеты** | рейтинг клиентов с ролью, приоритетом и обоснованием; фильтры «без seed», «без проверенных» |
| **Карточка клиента** | роль, evidence, устойчивость роли, разложение приоритета, признаки, контрагенты, решение аналитика |
